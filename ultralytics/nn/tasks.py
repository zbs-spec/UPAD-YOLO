...
from .Extramodule.AKconv import *
from .Extramodule.UDMConv import *
from .Extramodule.C2PSA_CAA import *
from .Extramodule.GoldYOLO import *
from .Extramodule.ASFF import *
from .Extramodule.PPA import *
from .Extramodule.APConv import *
import torch
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            if m is HGBlock:
                ...
                n = 1
        elif m is {ResNetLayer,ResNetLayer_APConv,}:
